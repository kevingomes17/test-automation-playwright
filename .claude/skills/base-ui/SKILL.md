---
name: base-ui
description: Reference index for the @base-ui/react component library. Use this skill when writing, debugging, or styling code that uses Base UI components (Accordion, Dialog, Select, Tooltip, Popover, Combobox, etc.), the useRender hook, mergeProps, or any @base-ui/react import. Each entry links to the official .md docs page that should be fetched with WebFetch on demand.
---
